...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        RepositorioPaciente.instance.cadastrar(p1);
        RepositorioDentista.instance.cadastrar(d1);
        RepositorioProcedimentos.instance.cadastrar(pr1);
        ...
        RepositorioPagamento.instance.cadastrar(pg1);
    }
}